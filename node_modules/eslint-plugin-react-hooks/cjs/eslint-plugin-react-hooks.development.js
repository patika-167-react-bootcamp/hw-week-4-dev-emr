    ...
    function visitFunctionWithDependencies(node, declaredDependenciesNode, reactiveHook, reactiveHookName, isEffect) {
      ...
      if (declaredDependenciesNode.type !== 'ArrayExpression') {
        ...
        reportProblem({
          ...
          message: "React Hook " + context.getSource(reactiveHook) + " was passed a " + 'dependency list that is not an array literal. This means we ' + "can't statically verify whether you've pas